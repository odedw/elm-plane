...
Elm.Update.make = function (_elm) {
   ...
   pillar) {
      return function () {
         var r2 = {_: {}
                  ,bottom: pillar.y - $Basics.toFloat(pillar.height) / 2
                  ...
                  ,top: pillar.y + $Basics.toFloat(pillar.height) / 2};
         var r1 = {_: {}
                  ,bottom: game.y - $Basics.toFloat(constants.planeHeight) / 2
                  ...
                  ,top: game.y + $Basics.toFloat(constants.planeHeight) / 2};
      ...
      return function () {
         ...
         {case "_Tuple2":
            return function () {
                 ...
                 50,
                 160,
                 50))($Text.height(50)($Text.fromString($Basics.toString(game.score)))));
                 var scoreForm = $Graphics$Collage.move({ctor: "_Tuple2"
                                                        ,_0: 0
